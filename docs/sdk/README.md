...
| --- | --- |
| [`python.md`](./python.md) | Install from the signed release wheel, the quickstart, and the API reference: `ServingClient`, `VisionClient`, `Detection`, the tensor value objects, the typed error hierarchy, and the scope boundaries. |
