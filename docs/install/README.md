...
| [`macos-cli.md`](./macos-cli.md) | Complete macOS Apple Silicon appliance install through the first-party Homebrew tap. |
...
| [`filesystem-layout.md`](./filesystem-layout.md) | Linux package and macOS Homebrew path / owner / mode contracts. |
