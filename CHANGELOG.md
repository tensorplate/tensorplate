...
- Every version surface moves to `0.3.1`, the first release of the 0.3
  ...
  line `0.3`, so its bracket check keeps refusing a runtime version
  outside the declared range. This is a runtime-version bump only: the
  protocol and schema versions stay `0.1`, the bundle format version
